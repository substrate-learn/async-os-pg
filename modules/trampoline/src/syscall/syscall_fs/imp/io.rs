//! 负责与 IO 相关的系统调用
extern crate alloc;
use crate::syscall::syscall_fs::solve_path;
// use crate::syscall_net::Socket;
use crate::syscall::{IoVec, SyscallError, SyscallResult};
...
use crate::syscall::syscall_fs::ctype::{
    dir::new_dir,
...
pub async fn syscall_dup3(args: [usize; 6]) -> SyscallResult {
    ...
    fd_table[new_fd] = fd_table[fd].clone();
    if flags as u32 & crate::syscall::ctypes::O_CLOEXEC != 0 {
