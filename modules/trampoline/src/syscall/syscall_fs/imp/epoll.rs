...
//! them.
extern crate alloc;
use crate::syscall::{SigMaskFlag, SyscallError, SyscallResult};
use alloc::sync::Arc;
use async_axhal::{mem::VirtAddr, time::current_ticks};
use executor::current_executor;

use crate::syscall::syscall_fs::ctype::epoll::{EpollCtl, EpollEvent, EpollFile};
...
pub async fn syscall_epoll_pwait(args: [usize; 6]) -> SyscallResult {
    ...
    crate::syscall::syscall_task::syscall_sigprocmask(temp_args).await?;
